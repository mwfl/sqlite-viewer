...
Visual Studio 2022 is supported through `vs2022-x64`. Standalone builds fetch the pinned MWFL `v0.2.0` release. SQLite itself is provided by `winsqlite3.dll` in Windows.
