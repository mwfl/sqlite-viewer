...
Visual Studio 2022 is supported through `vs2022-x64`. Standalone builds fetch the pinned mwfl v0.1.3 source. SQLite itself is provided by `winsqlite3.dll` in Windows.
